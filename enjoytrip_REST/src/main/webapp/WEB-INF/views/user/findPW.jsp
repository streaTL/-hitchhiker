      ...
      <div class="container d-flex align-items-center flex-column card2 border-white">
        ...
        <form name="login-form" class="login-form">
          <div class="d-flex mb-4 justify-content-md-between">
            ...
            <input type="text" class="form-control input-sm" id="userId" style="width: 200px" />
          </div>
          <div class="d-flex mb-4 justify-content-md-between">
            <h3 class="masthead-heading text-uppercase mb-0 fs-1" style="margin-right: 20px">
              E-MAIL
            </h3>
            <input type="text" class="form-control input-sm" id="userPw" style="width: 200px" />
          </div>
          <div class="d-flex mb-4 justify-content-md-between">
            <h3 class="masthead-heading text-uppercase mb-0 fs-1" style="margin-right: 20px">
              NAME
            </h3>
            <input type="text" class="form-control input-sm" id="userName" style="width: 200px" />
          </div>
          <a
