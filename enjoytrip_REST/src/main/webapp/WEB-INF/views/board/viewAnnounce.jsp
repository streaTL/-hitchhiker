		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<form action="writerAction" method="post">
					...
					<a class="btn btn-secondary mt-3 mb-3" href="${root}/board/modifyAnnounce/${board.articleNo}">수정</a>
					<a class="btn btn-secondary mt-3 mb-3" href="${root}/board/deleteAnnounce/${board.articleNo}">삭제</a>
				</form>
