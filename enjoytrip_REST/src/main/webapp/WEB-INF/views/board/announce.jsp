	...
	<section class="page-section masthead" id="contact">
		<div class="container">
			...
			<div class="row justify-content-center">
					...
					<tbody>
						<c:forEach var="board" items="${boards }">
							...
							<tr>
								...
								<td><a
									href="${root}/board?action=viewAnnounce&articleno=${board.articleNo}"
				...
				<div class="row justify-content-center">
					<a class="btn btn-dark text-nowrap mt-3 input-sm me-3" id="write"
						href="${root}/board/writeAnnounce.jsp">글쓰기</a>
				</div>
			</div>
		</div>
	</section>
